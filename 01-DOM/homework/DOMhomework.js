...
// Tu código acá:
let nombre = "daniel roman serna";
let span = document.querySelector("#createdBy") ;//tambien se puede hacer getElementById
span.innerHTML += " " + nombre;  // <span> nombre </span>
...
function buildToDo(todo, index) {
  ...
  let toDoText = document.createElement("spn")
  toDoText.innerHTML = todo.description // <span> description</span>
  toDoText.setAttribute( "id", index) // <span id = index > descripcion </span>
  if(todo.complete){
    toDoText.setAttribute("class", "completeTex")
  }
  toDoShell.appendChild(toDoText)// con este le asociamos como hijo
  //<div class = "toDoShell">
